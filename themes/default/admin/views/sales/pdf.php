                        ...
                        <div class="order_barcodes">
                            ...
                            if ($Settings->pdf_lib == 'dompdf') {
                                ...
                                if ($Settings->ksa_qrcode) {
                                    ...
                                    $svg = $this->sma->qrcode('text', $qrtext, 2, null, null, true);
                                    echo '<img src="data:image/svg+xml;base64,' . base64_encode($svg) . '"  width="100" height="100" />';
                                } else {
                                    $svg = $this->sma->qrcode('link', urlencode(site_url('view/sale/' . $inv->hash)), 2, null, null, true);
                                    echo '<img src="data:image/svg+xml;base64,' . base64_encode($svg) . '"  width="100" height="100" />';
                                }
                            }
                            ?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <?php if ($inv->shipping != 0) {
                        echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang('shipping') . ' (' . $default_currency->code . ')</td><td style="text-align:right;">' . $this->sma->formatMoney($inv->shipping - ($return_sale && $return_sale->shipping ? $return_sale->shipping : 0)) . '</td></tr>';
                    }
                    ?>
                    <tr>
                        <td colspan="<?= $col; ?>"
