                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-4">
                            <div class="small-box padding1010 borange">
                                ...
                                <p><?= $this->sma->formatMoney($total_purchases->paid) . ' ' . lang('paid') ?>
                        ...
                        <div class="col-sm-4">
                            <div class="small-box padding1010 bdarkGreen">
                                ...
                                <p><?= $this->sma->formatMoney($total_sales->paid) . ' ' . lang('paid') ?>
                        ...
                        <div class="col-sm-4">
                            <div class="small-box padding1010 bred">
                                ...
                                <h3 class="bold"><?= $this->sma->formatMoney($total_return_sales->total_amount) ?></h3>

                                <p class="bold"><?= $total_return_sales->total . ' ' . lang('returns') ?> </p>

                                <p><?= $this->sma->formatMoney($total_return_sales->tax) . ' ' . lang('tax') ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12">
                            <div class="small-box padding1010 bmGreen">
                                ...
                                <h3 class="bold"><?= $this->sma->formatMoney($total_received->total_amount - (0 - $total_returned->total_amount) - $total_paid->total_amount - $total_expenses->total_amount - ($total_return_sales ? $total_return_sales->total_amount : 0)) ?></h3>
    ...
    ?>
                    <div class="col-sm-4">
                        <div class="small-box padding1010 bblue">
                            ...
                            <h3 class="bold"><?= $this->sma->formatMoney(($warehouse_report['total_sales']->total_amount) - ($warehouse_report['total_purchases']->total_amount) - ($warehouse_report['total_returns']->total_amount)) ?></h3>

                            <p>
                            <?= lang('sales') . ' - ' . lang('purchases') . ' - ' . lang('returns'); ?>
                            </p>
                            ...
                            <?= $this->sma->formatMoney($warehouse_report['total_sales']->total_amount) . ' ' . lang('sales'); ?>
                                ...
                                <p>
                                <?= $this->sma->formatMoney($warehouse_report['total_returns']->total_amount) . ' ' . lang('returns') ?>
                                - <?= $this->sma->formatMoney($warehouse_report['total_returns']->tax) . ' ' . lang('tax') ?>
                                = <?= $this->sma->formatMoney($warehouse_report['total_returns']->total_amount - $warehouse_report['total_returns']->tax) . ' ' . lang('net_returns'); ?>
                                </p>
                                <hr style="border-color: rgba(255, 255, 255, 0.4);">

                                <?= '<h3 class="bold">' . $this->sma->formatMoney((($warehouse_report['total_sales']->total_amount - $warehouse_report['total_sales']->tax)) - ($warehouse_report['total_purchases']->total_amount - $warehouse_report['total_purchases']->tax) - ($warehouse_report['total_returns']->total_amount - $warehouse_report['total_returns']->tax)) . '</h3>'; ?>
                                <p>
                                <?= lang('net_sales') . ' - ' . lang('net_purchases') . ' - ' . lang('net_returns'); ?>
                                </p>
                                <hr style="border-color: rgba(255, 255, 255, 0.4);">
